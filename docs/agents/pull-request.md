...
- **Product logic**: `src/`. A change here lands with its tests in the same request.
- **Exempt**: `docs/`, `scripts/`, `*.config.*`, `.github/`, `README*`, and dependency bumps with no behaviour change.
